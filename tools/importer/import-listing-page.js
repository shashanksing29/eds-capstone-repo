...
const PAGE_TEMPLATE = {
  name: 'listing-page',
  description: 'Index/hub layout: heading with a grid of teaser cards linking to detail pages',
  urls: [
  ...
  blocks: [
    ...
    { name: 'article-list', instances: ['#articles > div.container > div.grid-layout.desktop-4-column.tablet-2-column-1.mobile-portrait-1-column.grid-gap-md'] },
  ],
  sections: [
    ...
    { id: 'rc3', name: 'Latest articles listing', selector: '#articles', style: 'light-grey', blocks: ['article-list'], defaultContent: [] },
